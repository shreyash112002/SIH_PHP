 ...
 >   <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <form class="form-signin" name="loginform" action="authenticate1.php" method="POST">
                ...
                <a href="#" class="pull-right need-help">Not Registered? Contact Class Teacher </a><span class="clearfix"></span>
                </form>
            </div>
        </div>
    </div>
