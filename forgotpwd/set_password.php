...
// Logic to set the password of the user who creates first time account
// Need to change the password to store and retrive in the md5 hash
	...
	if(isset($_POST["set-password"])) {
		...
		$sql1 = "UPDATE usercredential SET password = '". $_POST["user_password"] . "' , isDisabled = 0 WHERE username = '".$username."'";

		//echo $sql1;

		$result = mysqli_query($conn,$sql1);

		$success_message = "Password is Set successfully.";
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <br>
                <button class="btn btn-lg btn-primary btn-block" type="submit" id="set-password" name="set-password" name="submit" value="Submit" >
                    Set Password </button>
                </form>
            </div>
            <br><br> <br><br> <br><br>
